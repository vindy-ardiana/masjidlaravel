<x-landing-layout>
    <div class="w-full">
        <img class="w-full" src="{{asset('/asset/mosquehd.png')}}"/>
    </div>
    ...
    <div class="w-full p-12">
        ...
        <div class="flex gap-6">
            <div class="p-8 m-4 mr-0 bg-indigo-300 rounded-md shadow-sm w-1/2">
            ...
            <div class="p-8 m-4 ml-0 bg-indigo-300 rounded-md shadow-sm w-1/2">
